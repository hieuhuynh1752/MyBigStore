<?php
	...
	$latests_product_single = latests_product_single();
...
<div id="picture-frame">
			<img src="shop_admin/images/products/<?php echo $product['image']?>" class="img-responsive" alt="">
		</div>
			...
			<div class="col-md-7 single-top-left ">
				...
				<h3><?php echo $product['productName']?></h3>
				 ...
				 <div class="pr-single">
				  <p class="reduced "><del>$<?php echo 2*$product['price']?></del>$<?php echo $product['price']?></p>
				</div>
				<div class="block block-w3">
					<div class="starbox small ghosting"> </div>
				</div>
				<p class="in-pa"> <?php echo $product['description']?></p>
				...
				<ul class="social-top">
					...
					<div class="add add-3 snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
											<form action="#" method="post">
											<fieldset>
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
											<input type="hidden" name="business" value=" " />
											<input type="hidden" name="item_name" value="<?php echo $product['productName']?>" />
				...
				<h3>Special Offers</h3>
					<div class="ser-t">
						...
						<div class=" con-w3l wthree-of">
							...
							<?php foreach ($latests_product_single as $key => $value) {
								?>

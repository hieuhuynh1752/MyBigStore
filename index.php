<?php
	...
	$latests_product_head = latests_product_head();
	$latests_product_head1 = latests_product_head1();
	$latests_product_head2 = latests_product_head2();
	$latests_product_head3 = latests_product_head3();
	$latests_product_tail = latests_product_tail();
			...
			<div class="tab-head ">
				...
				<div class=" tab-content tab-content-t ">
					...
					<div class="tab-pane active text-style" id="tab1">
						...
						<div class=" con-w3l">
						<?php foreach ($latests_product_head as $key => $value) {
								?>
					...
					<div class="tab-pane  text-style" id="tab2">
						<div class=" con-w3l">
						<?php foreach ($latests_product_head1 as $key => $value) {
								?>
							<div class="col-md-3 m-wthree">
					...
					<div class="tab-pane  text-style" id="tab3">
						<div class=" con-w3l">
						<?php foreach ($latests_product_head2 as $key => $value) {
								?>
							<div class="col-md-3 m-wthree">
					...
					<div class="tab-pane text-style" id="tab4">
							<div class=" con-w3l">
						<?php foreach ($latests_product_head3 as $key => $value) {
								?>
							<div class="col-md-3 m-wthree">
								...
								<div class="col-m">	
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.php?productID=<?php echo $value['productID']?>" name="proid"><?php echo $value['productName']?></a></h6>							
										</div>
										<div class="mid-2">
											<p ><label>$<?php echo 2*$value['price']?></label><em class="item_price">$<?php echo $value['price']?></em></p>
											  <div class="block">
  ...
  <!-- Carousel
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
         <a href="#"> <img class="second-slide " src="images/ba1.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
          <a href="#"><img class="third-slide " src="images/ba2.jpg" alt="Third slide"></a>
	...
	<div class="product">
		<div class="container">
			<div class="spec ">
				...
				<div class=" con-w3l">
						<?php foreach ($latests_product_tail as $key => $value) {
								?>
							<div class="col-md-3 m-wthree">
...
<div class="footer">
	<div class="container">
		...
		<div class="copy-right">
			<p> &copy; 2019 Big store. All Rights Reserved | Design by  <a href="http://w3layouts.com/"> W3layouts</a></p>
		</div>
	</div>
